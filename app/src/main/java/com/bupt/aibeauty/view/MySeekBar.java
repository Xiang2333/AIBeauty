...
public class MySeekBar extends View {
    ...
    private static final int DEFAULT_RANGE_COLOR = Color.argb(0xFF,0xFF,0x66,0x66);
    ...
    //选择SeekBar的样式
    public static final boolean DEFAULT_STYLE=false;
    public static final boolean CENTER_STYLE=true;
    //默认原点在最左边
    public  boolean style=DEFAULT_STYLE;
    ...
    public interface OnSeekBarChangeListener {
        void onSeekBarValueChange(MySeekBar bar, double value);
        void onSeekBarValueChangeStart(MySeekBar bar);
        void onSeekBarValueChangeStop(MySeekBar bar);
    }
    ...
    public MySeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MySeekBar,
                defStyleAttr, 0);

        Drawable thumbImageDrawable = a.getDrawable(R.styleable.MySeekBar_thumbDrawable);
        if (thumbImageDrawable == null) {
            //thumbImageDrawable = getResources().getDrawable(R.drawable.seek_thumb_normal);
            thumbImageDrawable = getResources().getDrawable(R.drawable.ic_seekbar_thumb_normal);
        }
        this.thumbImage = ((BitmapDrawable) thumbImageDrawable).getBitmap();

        Drawable thumbImagePressedDrawable = a.getDrawable(R.styleable.MySeekBar_thumbPressedDrawable);
        if (thumbImagePressedDrawable == null) {
            //thumbImagePressedDrawable = getResources().getDrawable(R.drawable.seek_thumb_pressed);
            thumbImagePressedDrawable = getResources().getDrawable(R.drawable.ic_seekbar_thumb_pressed);
        }
        this.thumbPressedImage = ((BitmapDrawable) thumbImagePressedDrawable).getBitmap();

        this.absoluteMinValue = a.getFloat(R.styleable.MySeekBar_minValue, DEFAULT_MIN_VALUE);
        this.absoluteMaxValue = a.getFloat(R.styleable.MySeekBar_maxValue, DEFAULT_MAX_VALUE);

        this.defaultBackgroundColor = a.getColor(R.styleable.MySeekBar_defaultBackgroundColor,
                DEFAULT_BACKGROUND_COLOR);
        this.defaultRangeColor = a.getColor(R.styleable.MySeekBar_defaultBackgroundRangeColor,
                DEFAULT_RANGE_COLOR);
    ...
    public double getMinValue(){return absoluteMinValue;}
    public double getMaxValue(){return absoluteMaxValue;}
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                attemptClaimDrag();
                if(listener!=null){
                    listener.onSeekBarValueChangeStart(this);
                }
                break;
            case MotionEvent.ACTION_MOVE:
                if (isThumbPressed) {
                    ...
                    if (notifyWhileDragging && listener != null) {
                        listener.onSeekBarValueChange(this, normalizedToValue(normalizedThumbValue));
                    }
                }
                break;
            case MotionEvent.ACTION_UP:
                ...
                if (listener != null) {
                    listener.onSeekBarValueChange(this, normalizedToValue(normalizedThumbValue));
                    listener.onSeekBarValueChangeStop(this);
                }
                break;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(style==CENTER_STYLE){
            ...
            rect.left = normalizedToScreen(valueToNormalized(absoluteMinValue));
            rect.right = normalizedToScreen(normalizedThumbValue);
        }
